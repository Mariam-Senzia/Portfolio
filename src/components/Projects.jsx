...
const Projects = () => {
    ...
    return (
        <>
        <Box mt={{base:'131.5rem',xxm:'127rem',xm:'114rem',sm:'108rem',xmd:'107rem',md:'102rem',slg:'50rem',lg:'51rem',xl:'15rem',xxl:'24rem'}} bgColor='#F5F5F5' p='3rem' textAlign='center' height={{base:'350vh',xxm:'265vh',xm:'250vh',sm:'230vh',xmd:'200vh',md:'180vh',slg:'102vh',lg:'150vh',xl:'140vh',dm:'110vh',xxl:'130vh'}} >
