    ...
    return (
        ...
        <Box mt={{base:'103rem',xxm:'98rem',xm:'92rem',sm:'88rem',xmd:'85rem',md:'80rem',slg:'85rem',lg:'24.4rem',xl:'20.5rem',xxl:'24rem'}} bgColor='#F5F5F5' p='3rem' textAlign='center' height={{base:'150vh',xxm:'',xm:'',sm:'',xmd:'',md:'100vh',slg:'90vh',lg:'',xl:'90vh',xxl:''}} >
            ...
            {myProjects.map((project) => {
                ...
                <Image src={project.image} alt='image' width={{base:'450px',dm:'600px'}} borderRadius='10px'/>

                <Box ml={{base:'-1.5rem',xxm:'',xm:'',sm:'-0.5rem',xmd:'',md:'',slg:'8rem',lg:'9rem',xl:'10rem',xxl:'21rem'}} textAlign='left'>
                    <Heading ml={{base:'3.5rem',xxm:'',xm:'4.5rem',sm:'5rem',xmd:'8.5rem',md:'',slg:'0',lg:'',xl:'0',dm:'2.5rem',xxl:''}} mt={{base:'1rem',xxm:'',xm:'',sm:'',xmd:'2rem',md:'',slg:'0',lg:'',xl:'',xxl:''}}>{project.title}</Heading>
                    <Text width={{base:'18.5rem',xxm:'20rem',xm:'21.7rem',sm:'24rem',xmd:'29rem',md:'',slg:'24rem',lg:'24.5rem',xl:'27rem',xxl:''}} ml={{dm:'2.5rem'}} mt='1rem'>{project.description}</Text>
