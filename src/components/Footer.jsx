...
const Footer = () => {
    return (
        ...
        <Box bgColor='#0E1116' p='2rem' height={{base:'55vh',xxm:'40vh',xm:'38vh',sm:'35vh',xmd:'30vh',md:'26vh',slg:'21vh',lg:'35vh',xl:'36vh',xxl:'27vh'}}>
            <Image src='/Black White Minimalist Initials Monogram Jewelry Logo.png' alt='logo' borderRadius='50px' height='70px' ml={{base:'6rem',xxm:'7rem',xm:'8rem',sm:'9rem',xmd:'19.5rem',md:'21.5rem',slg:'27.5rem',lg:'35.5rem',xl:'41.5rem',xxl:'48rem'}} mt='rem' mb='0.5rem'/>
