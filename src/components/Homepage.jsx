    ...
    return (
        ...
        <Box bgColor='#F5F5F5' mt={{base:'4.2rem',xxm:'',xm:'',sm:'',xmd:'',md:'',slg:'',lg:'',xl:'5.1rem',xxl:''}} p='3rem' height={{base:'',xxm:'',xm:'',sm:'',xmd:'',md:'',slg:'',lg:'90vh',xl:'88.5vh',xxl:''}} >
            ...
            <Box>
                ...
                <Image src='https://cdn.pixabay.com/photo/2024/05/20/13/28/ai-generated-8775232_1280.png' alt='coding' height={{base:'',xxm:'',xm:'',sm:'',xmd:'60vh',md:'65vh',slg:'',lg:'56vh',xl:'58vh',xxl:'65vh'}} width={{base:'',xxm:'',xm:'',sm:'',xmd:'',md:'60vh',slg:'',lg:'50vw',xl:'105vh',xxl:''}}  ml={{base:'-2rem',xxm:'-2.2rem',xm:'',sm:'',xmd:'3rem',md:'2rem',slg:'3rem',lg:'17rem',xl:'18.5rem',xxl:'14rem'}} mt={{base:'1rem',xxm:'',xm:'',sm:'3rem',xmd:'4rem',md:'',slg:'8rem',lg:'3rem',xl:'3rem',xxl:''}} borderRadius='100px'/>
            </Box>
