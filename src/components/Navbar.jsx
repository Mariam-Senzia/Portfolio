   ...
   return (
    <>
      <Box display='flex' position='fixed' bgColor='white' mt={{base:'-4.2rem',xxm:'',xm:'',sm:'',xmd:'',md:'',slg:'',lg:'',xl:'-5.1rem',xxl:''}} width='100vw' zIndex='100' >
         <Link href='#home'>
            <Image src='/Portfolio/Black White Minimalist Initials Monogram Jewelry Logo.png' alt='logo' borderRadius='50px' height={{base:'60px',xxm:'',xm:'',sm:'',xmd:'',md:'',slg:'',lg:'',xl:'70px',xxl:''}} ml={{base:'1rem',xxm:'',xm:'1.5rem',sm:'2rem',xmd:'',md:'',slg:'5rem',lg:'9rem',xl:'12.5rem',dm:'13rem',xxl:''}} mt='0.3rem' mb='0.3rem'/>
         </Link>
            ...
            <Flex mr='rem' mt='1.7rem' ml={{base:'',xxm:'',xm:'',sm:'',xmd:'10rem',md:'13rem',slg:'19rem',lg:'30rem',xl:'33rem',xxl:'45rem'}} display={{base:'none',xxm:'',xm:'',sm:'',xmd:'flex',md:'',slg:'',lg:'',xl:'flex',xxl:''}}>
               <Link href='#home' _hover={{textDecoration:'none'}}>
                  <Text mr={{base:'5.5rem',dm:'9rem'}}  ml={{dm:'rem'}} _hover={{color: '#FF5A5F'}}>Home</Text>
               </Link>

               <Link href='#about' _hover={{textDecoration:'none'}}>
                  <Text mr={{base:'5.5rem',dm:'9rem'}} _hover={{color: '#FF5A5F'}}>About</Text>
               </Link>

               <Link href='#projects' _hover={{textDecoration:'none'}}>
                  <Text mr={{base:'5.5rem',dm:'9rem'}} _hover={{color: '#FF5A5F'}}>Projects</Text>
               </Link>
